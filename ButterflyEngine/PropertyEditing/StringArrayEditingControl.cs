...
namespace ButterflyEngine
{
    ...
    public class StringArrayEditingControl : Control
    {
        /// <summary>
        /// Constructor</summary>
        ...
        private void OnItemChanged(object item, object newValue)
        {
            ...
            {
                m_itemControls[i].Value = array.GetValue(i) as string;
        ...
        private class ItemControl : Panel
        {
            public ItemControl(int index, object item, int indexColumnWidth)
            {
                ...
                m_editControl.Text = item as string;
                m_editControl.Invalidated += editControl_Invalidated;
                m_editControl.TextChanged += m_editControl_ValueChanged;
            ...
            public string Value
            {
                get { return m_editControl.Text; }
                set { m_editControl.Text = value; }
            }
            ...
            private readonly TextBox m_editControl;
        }
        #endregion
